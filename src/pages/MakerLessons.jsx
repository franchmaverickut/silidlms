    ...
    <div className="space-y-6">
      ...
      {(skillFilter === "All" || skillFilter === "3D Printing") && !search && (
        <div className="space-y-4">
          ...
          {[
            { to: "/maker/tinkercad-fundamentals", img: "https://media.base44.com/images/public/69d386ad9523e2ce04536574/161f8ce2e_cover.png", title: "Tinkercad Fundamentals", desc: "Learn the core Tinkercad tools — basic shapes, precision controls, grouping, duplication and mini-projects.", b1: "bg-violet-600", b1l: "Guide", b2: "bg-green-600", b2l: "Beginner", shareKey: "tinkercad-fundamentals", shareLabel: "Tinkercad Fundamentals" },
            { to: "/maker/quick-clips", img: "https://media.base44.com/images/public/69d386ad9523e2ce04536574/682842f2f_image.png", title: "Quick Clips", desc: "Use a 2D sketch to 3D model workflow to design cable tidies, bag holders, filament clips and more.", b1: "bg-purple-600", b1l: "Project", b2: "bg-green-600", b2l: "Beginner", shareKey: "quick-clips", shareLabel: "Quick Clips" },
            { to: "/maker/printing-technologies", img: "https://media.base44.com/images/public/69d386ad9523e2ce04536574/e4eff125d_image.png", title: "3D Printing Technologies", desc: "Learn about 6 key types of 3D printing — materials, applications, benefits & limitations. Certificate on 70%+.", b1: "bg-pink-600", b1l: "Online Course", b2: "bg-white/20", b2l: "Technologies", shareKey: "printing-technologies", shareLabel: "3D Printing Technologies" },
            { to: "/maker/printing-industry", img: "https://media.base44.com/images/public/69d386ad9523e2ce04536574/3257ecd04_image.png", title: "The 3D Printing Industry", desc: "A bitesize online course covering key aspects of the 3D printing industry. Score 70%+ to earn a certificate!", b1: "bg-indigo-600", b1l: "Online Course", b2: "bg-white/20", b2l: "Industry", shareKey: "printing-industry", shareLabel: "3D Printing Industry" },
            ...
            { to: "/maker/puzzle-cubes", img: "https://media.base44.com/images/public/69d386ad9523e2ce04536574/c44bb0b59_PuzzleCubes.png", title: "Puzzle Cubes", desc: "Design and 3D print a puzzle cube made of separate pieces that fit together to form one perfect cube.", b1: "bg-purple-600", b1l: "Project", b2: "bg-green-600", b2l: "Basic", shareKey: "puzzle-cubes", shareLabel: "Puzzle Cubes" },
            { to: "/maker/functional-wrenches", img: "https://media.base44.com/images/public/69d386ad9523e2ce04536574/9f8f426ef_FunctionalWrenches.png", title: "Functional Wrenches", desc: "Design and 3D print a functional wrench that can tighten or loosen a nut and bolt.", b1: "bg-blue-600", b1l: "Project", b2: "bg-green-600", b2l: "Basic", shareKey: "functional-wrenches", shareLabel: "Functional Wrenches" },
