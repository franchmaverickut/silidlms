...
const HARDCODED_STEM = [
  { href: "/share/quick-clips", img: "https://media.base44.com/images/public/69d386ad9523e2ce04536574/682842f2f_image.png", title: "Quick Clips", desc: "Use a 2D sketch to 3D model workflow to design cable tidies, bag holders, filament clips and more.", badges: [{ label: "Project", color: "bg-purple-600" }, { label: "Beginner", color: "bg-green-600" }] },
  { href: "/share/printing-technologies", img: "https://media.base44.com/images/public/69d386ad9523e2ce04536574/e4eff125d_image.png", title: "3D Printing Technologies", desc: "Learn about 6 key types of 3D printing — materials, applications, benefits & limitations. Certificate on 70%+.", badges: [{ label: "Online Course", color: "bg-pink-600" }, { label: "Technologies", color: "bg-white/20" }] },
  { href: "/share/printing-industry", img: "https://media.base44.com/images/public/69d386ad9523e2ce04536574/3257ecd04_image.png", title: "The 3D Printing Industry", desc: "A bitesize online course on key aspects of the 3D printing industry. Score 70%+ to earn a certificate!", badges: [{ label: "Online Course", color: "bg-indigo-600" }, { label: "Industry", color: "bg-white/20" }] },
