...
import { GRADE6_MAKER_LESSONS } from "./lessonDataGrade6";

const ALL_LESSONS = [...GRADE1_MAKER_LESSONS, ...GRADE2_MAKER_LESSONS, ...GRADE3_MAKER_LESSONS, ...GRADE4_MAKER_LESSONS, ...GRADE6_MAKER_LESSONS];
